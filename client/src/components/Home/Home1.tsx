			...
			<div className="absolute inset-0 z-0 h-full w-full items-center [background:radial-gradient(125%_125%_at_50%_10%,#000_40%,#63e_100%)] ">
				...
				<motion.div
					...
					<motion.span
						...
						className="w-12 h-12 bg-white rounded-full flex items-center justify-center hover:cursor-pointer z-30 hover:scale-110 hover:border-blue-400 hover:border-2">
						<FaArrowDown />
					</motion.span>
				</motion.div>
			</div>
